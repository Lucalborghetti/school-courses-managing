  ...
  export default {
    ...
    created() {
      if (!this.user_role) {
        ...
        axios.get('https://localhost:8443/courses/all', {withCredentials: true})
          .then(response => {
        ...
        axios.get('https://localhost:8443/period', {withCredentials: true})
          .then(response => {
          ...
          buttons: [
            {
              ...
              handler: () => {
                axios.get('https://localhost:8443/courses/end', {withCredentials: true})
                  .then(response => {
                    // Then ...
