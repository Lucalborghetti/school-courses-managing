  ...
  export default {
    ...
    created() {
      ...
      if (!this.user_role) {
        ...
        if (this.isProf) {
          axios.get(
            `https://localhost:8443/users/${this.user_username}/courses/`,
        ...
        axios
          .get("https://localhost:8443/courses/", {withCredentials: true})
          .then(response => {
        ...
        if (!this.isProf) {
          ...
          axios.get(
            `https://localhost:8443/users/${this.user_username}/registrations/`,
            {withCredentials: true}
          )
            .then(response => {
        ...
        // then update with the registrations
        axios.get(`https://localhost:8443/registrations/count`, {withCredentials: true})
          .then(response => {
