  ...
  export default {
    ...
    created() {
      if (!this.user_role) {
        ...
        axios.get(`https://localhost:8443/courses/${this.coursID}`, {withCredentials: true})
          .then(response => {
    ...
    methods: {
      ...
      postAdd(event) {
        axios.post('https://localhost:8443/courses/update', {
          oldCours: this.cours,
      ...
      loadTeachers() {
        ...
        axios.get('https://localhost:8443/users/teachers/', {withCredentials: true})
          .then(response => {
      ...
      loadImplicatedTeachers() {
        axios.get(`https://localhost:8443/courses/${this.coursID}/implication`, {withCredentials: true})
          .then(response => {
      ...
      loadRegisteredStudents(){
        axios.get(`https://localhost:8443/courses/${this.coursID}/registrations`, {withCredentials: true})
          .then(response => {
